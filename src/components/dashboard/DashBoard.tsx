...
const DashBoard = () => {
  ...
  return (
    <div className='w-full max-w-full px-4 mt-3 h-full  sm:px-6'>
      ...
      <div className=' mt-5 flex flex-col gap-4  md:flex md:flex-row    md:gap-4 lg:gap-8 lg:flex lg:mt-[5.5%] lg:flex-row md:mt-24  '>
        <DashboardGraph />
        <Calender />
      </div>
      {/* <ToastNotification /> */}
