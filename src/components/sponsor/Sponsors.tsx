...
const Sponsors = () => {
  ...
  return (
    <div className='w-full max-w-full px-4 sm:px-6 font-montserrat h-screen overflow-y-hidden'>
      ...
      <section
        className='px-20 py-7 gap-y-6 my-10 mx-auto w-[98%] bg-[#FDFDFD] border border-[#D6D4D4] rounded-xl h-auto
      '
      >
