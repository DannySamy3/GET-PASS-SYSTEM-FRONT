...
const Calendar = () => {
  ...
  return (
    <div className='w-[100%] lg:max-w-[30%] md:w-[45%]  lg:mt-0 md:mt-0  h-[330px] md:h-[380px] lg:min-h-[20%] bg-white dark:bg-neutral-900 rounded-xl shadow overflow-hidden font-montserrat'>
      {/* Month Navigation */}
